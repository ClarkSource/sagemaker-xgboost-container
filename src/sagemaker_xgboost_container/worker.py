...
from sagemaker_inference import content_types, environment, logging
from sagemaker_xgboost_container import mapping
    ...
    def __init__(
        ...
        Args:
            ...
            module_name (str): the module name which implements the worker. If not specified, it
                               will use sagemaker_containers.Environment().module_name as the default
                               module name.
        """
...
class Request(flask.Request, mapping.MappingMixin):
    ...
    >>> from sagemaker_containers import environment
    ...
    def __init__(self, environ=None, servingenvironment=None):  # type: (dict, environment.Environment) -> None
        """Placeholder docstring"""
        super(Request, self).__init__(environ=environ or flask.request.environ)

        servingenvironment = servingenvironment or env

        self._default_accept = servingenvironment.default_accept
